...
png(filename = "Scripts/Figures/DisProp_L0_ribo_7-8-19.png", height = 400, width = 400)
...
png(filename = "Scripts/Figures/Hydrophilic_L0_ribo_7-8-19.png", width = 400, height = 400)
ggplot(data = ribohits.data[ribohits.data$Fragile == 0,],
       aes(x = log(Length.0),
