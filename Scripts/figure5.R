...
png(filename = "Scripts/Figures/Disprop_weighted_loess_lm_12-18-19.png", width = 6, height = 6, units = "in", res = 350)
#ggExtra::ggMarginal(fig.5a.dprop, type = "histogram")
fig.5a.dprop
dev.off()
...
fig.5a.rsa <-
  ...
  scale_x_continuous(breaks = log10(c(0.5, 1.5, 10.5, 100.5, 1000.5)),
                     labels = c(0, 1, 10, 100, 1000)) +
  theme_bw(base_size = 28)
png(filename = "Scripts/Figures/RSA_weighted_loess_lm_12-18-19.png", width = 6, height = 6, units = "in", res = 350)
#ggExtra::ggMarginal(fig.5a.rsa, type = "histogram")
fig.5a.rsa
dev.off()
